...
if __name__ == "__main__":
    ...
    met_fname = os.path.join(met_dir, "AU-Tum_2002-2010_OzFlux_Met.nc")
    ...
    ofname = os.path.join(local_met_dir, "%s_met_trans.nc" % (site))
    G.create_transient_file(ofname)


    ofname = os.path.join(local_met_dir, "%s_met_simulation.nc" % (site))
